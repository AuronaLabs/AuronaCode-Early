...
export const en: LocaleMessages = {
  ...
  settings: {
    ...
    extensionsSettings: {
      ...
      vscodeCompatTitle: "VSCode Compatibility Runtime",
      builtinBadge: "Built-in",
      vscodeCompatDescription:
        "Provides the vscode API compatibility runtime for VSIX extensions. It ships with Aurona Code, is hidden from the sidebar and cannot be uninstalled from the Marketplace.",
      ...
      vscodeTestTitle: "VSCode Test Extensions",
      vscodeTestDescription:
        "Install the bundled official demo plugin with one click, or pick a local .vsix file. Installed extensions appear in the sidebar and can be uninstalled anytime.",
      vscodeTestInstallDefault: "Install Default Test Plugin",
      vscodeTestInstallLocal: "Install Local .vsix…",
