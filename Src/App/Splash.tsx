  ...
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-8 z-10 pointer-events-none">
        ...
        <div className="w-12 h-1 mt-2 bg-gradient-to-r from-[var(--AccentPrimary)] to-purple-500 rounded-full opacity-80"></div>
      </div>
      ...
      <div className="absolute bottom-8 right-8 z-10 flex items-center gap-3 pointer-events-none drop-shadow-md">
        ...
        <svg className="w-5 h-5 text-white animate-spin drop-shadow-lg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
