...
export const glassVariants = cva(
  "rounded-surface border border-[var(--border-subtle)] transition-[background-color,border-color,box-shadow,transform] duration-300",
  {
    variants: {
      layer: {
        ...
        overlay:
          "glass-layer-overlay rounded-overlay bg-[var(--surface-overlay)] backdrop-blur-[var(--surface-blur-overlay)] backdrop-saturate-[var(--GlassSaturation)] shadow-[var(--shadow-overlay)]",
      },
      interactive: {
