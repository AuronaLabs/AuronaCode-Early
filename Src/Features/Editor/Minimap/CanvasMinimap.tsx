...
export const CanvasMinimap = React.memo(function CanvasMinimap({
  ...
  return (
    ...
    >
      ...
      {hoveredLine && (
        <div
          className="absolute right-full mr-2 z-50 pointer-events-none px-2.5 py-1 rounded-lg border border-[var(--border-overlay)] bg-[var(--material-overlay)] backdrop-blur-[var(--glass-blur-overlay)] shadow-lg text-[11px] font-mono text-[var(--color-text-highlight)] max-w-sm truncate whitespace-pre"
          style={{
