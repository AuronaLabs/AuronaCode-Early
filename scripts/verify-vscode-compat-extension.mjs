...
const aurxPath = join(root, "src-tauri", "resources", "extensions", "aurona.vscode-compat.aurx");
...
function main() {
  ...
  console.log(`aurona.vscode-compat.aurx 校验通过: ${aurxPath} (${data.length} bytes)`);
}
